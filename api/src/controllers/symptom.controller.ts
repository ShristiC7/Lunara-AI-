...
export const updateSymptom = asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  const symptom = await SymptomService.updateSymptom(id, req.userId, req.body);
